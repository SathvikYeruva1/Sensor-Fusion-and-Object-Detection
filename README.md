...
In order to run the code properly follow all of the set up instructions within the the mid-term project and the ones given in the steps for this final project.


GitHub Link: https://github.com/SathvikYeruva1/Sensor-Fusion-and-Object-Detection 
